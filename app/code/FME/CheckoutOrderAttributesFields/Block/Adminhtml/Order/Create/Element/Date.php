...
class Date extends \FME\CheckoutOrderAttributesFields\Block\Adminhtml\Order\Create\Element\AbstractRenderer
{
    /**
    ...
    public function __construct(
        ...
        \FME\CheckoutOrderAttributesFields\Block\Adminhtml\Order\Create\Element\Framework\Date $dateElement,
        array $data = []
    ) {
     ...
     * @return string
     */
    public function getDateElementHtml($form = null, $default = null)
    {
        $this->dateElement->setData([
            'name' => $this->getAttributeName(),
            'id' => $this->getAttributeId(),
            'class' => 'admin__control-text '. $this->getValidateClasses(),
            'value' => $default == null?$this->getValue():$default,
