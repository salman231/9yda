...
class Repository implements StatusRepositoryInterface
{
    ...
    public function clearDeleted()
    {
        ...
        $statusCollection->getSelect()->reset(\Zend_db_select::WHERE);
    ...
    private function isLastState(StatusInterface $status)
    {
        ...
        $collection->addFieldToFilter(StatusInterface::STATE, $status->getState())
            ->addFieldToFilter(StatusInterface::IS_DELETED, 0);
